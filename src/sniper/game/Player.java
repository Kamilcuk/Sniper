...
public class Player extends Sprite {
    ...
    public void levelUp(String var) {
        ...
        switch (var) {
            ...
            case "playerAttack":
                playerAttack *= 1.1;
                break;
            case "playerAttackSpeed":
                playerAttackSpeed *= 0.95;
                break;
            case "playerSpeed":
                playerSpeed *= 1.05;
                break;
            default:
                System.out.println("ERROR IN Player.levelup string: " + var);
        }
        playerLevel++;
    }
    ...
    /**
     * Prywatna funkcja ustawiająca prędkość gracza w zależności od wciśniętych
     * klawiszy klawiatury.
     */
    ...
    /**
     * zwraca stosunek życia gracza do maxa zycia gracza (wartość od 0.0 do
     * 1.0).
     *
     * @return
     */
