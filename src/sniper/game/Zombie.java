...
public class Zombie extends Sprite {
    private final TimeMeasurer timeMeasurer = new TimeMeasurer();
    ...
    /**
     * pomocnicza funkcja odpowiadająco za określenie parametrów zombiaka
     * (życie, attack, prędkość, wygląd, wielkość) w zależności od podanego
     * typu)
     *
     * @param type
     */
    private void setType(final int type) {
        ...
        switch (type) {
            ...
            case 3: // big, life + big attack
                ...
                imageSize = 80;
                movingSpeed = 0.9 * poziomTrudnosci;
                hp = 300 * poziomTrudnosci;
                zombieAttack = 30 * poziomTrudnosci;
    ...
    int getZombieAttack() {
        if ( timeMeasurer.runAfterTimeHasPassed((long)zombieAttackSpeed)) {
